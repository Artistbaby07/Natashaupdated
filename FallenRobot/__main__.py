...
buttons = [
    [
        ...
        InlineKeyboardButton(text="Updates", url="https://t.me/natasha_logss"),
      ],
    [
        InlineKeyboardButton(text="Support", url="https://t.me/natashaSupport"),
        InlineKeyboardButton(text="Commands", callback_data="help_back"),
      ],
    [
        InlineKeyboardButton(text="️Add Me", url="t.me/Natasha_ro_bot?startgroup=true"),
    ],
]

HELP_STRINGS = """
Hey there! My name is Natasha.
                ...
                [
                    [
                        InlineKeyboardButton(
                            text=" Setup Guide ", url="https://t.me/natashasupport/22",
                        ),
                        InlineKeyboardButton(
                            text="Support chat", url="https://t.me/natashasupport",
                        ),
                    ],
                    [
                        ...
                        InlineKeyboardButton(
                            text="Gban logs", url="https://t.me/natasha_logss",
                        ),   
                    ],     
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *natasha*
                 \nHere is the [Source Code](t.me/crazy_1299) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(kazuko_about_callback, pattern=r"kazuko_", run_async=True)
